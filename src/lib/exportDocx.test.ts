...
const artist: ArtistSubmission = {
  id: 'artist', sourceRow: 2, fullName: 'Alice Example', firstName: 'Alice', surname: 'Example', email: 'a@example.com', dateOfBirth: '2000-01-01', warnings: [],
  artworks: [
...
describe('DOCX row selection', () => {
  it('exports only included artworks in Y/N/M order and respects omitted fields', () => {
    ...
    expect(rows[0]).toMatchObject({ title: 'One', yes: 5, no: 0, maybe: 2, email: '' })
  })
})
