...
const row = (artworkId: string, name: string): ExportRow => ({ artworkId, artistId: 'artist', firstName: '', surname: '', title: '', price: '', yes: 0, no: 0, maybe: 0, email: '', dobYoungArtist: '', includeDownload: true, verdict: 'tie', localImage: new Blob(['image']), localImageName: name })
